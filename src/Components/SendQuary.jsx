  ...
  return (
    <div className=" m-auto mb-16 w-[70%] screen-mobile" >
      ...
      <p className="img px-5">
        ...
        <div className=' one'>
          <p className=" font-semibold pb-3 text-gray-500 text-2xl">Send Query</p>
        ...
        <div className={`hidden-box font-semibold ${isVisible ? "active-box-send " : ""}`}>
          <div className=' w-[90%] m-auto'>
            <form>
              <div className="grid form-input gap-6 mb-6">
                ...
                <div>
                  <label htmlFor="order-no" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Order no.</label>
                  <input type="text" id="order-no" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" required/>
                </div>
              </div>
              ...
              <div className='form-after-div justify-center flex'>
                <button type="submit" className="text-white bg-pink-600 hover:bg-pink-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-20 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
              </div>
            </form>
          </div>
        </div>
